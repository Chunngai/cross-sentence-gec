...
def get_documents_from_json(document_file_paths: List[str], m2_file_paths: List[str],
                            raw_ori_file_path: str, sp_ori_file_path: str) -> List[List[str]]:
...
def get_documents_from_sgml(document_file_paths: List[str], m2_file_paths: List[str],
                            raw_ori_file_path: str, sp_ori_file_path: str,
...
def get_documents_from_lang8_entries_train(document_file_paths: List[str],
                                           raw_ori_file_path: str, sp_ori_file_path: str) -> List[List[str]]:
                    ...
                    try:
                        ...
                        if document_sentence == raw_ori_sentence:
                            ...
                            while True:
                                ...
                                if previous_sp_ori_sentence != sp_ori_sentence:
                                    break
...
def get_documents(document_file_paths: List[str], m2_file_paths: List[str],
                  raw_ori_file_path: str, sp_ori_file_path: str) -> List[List[str]]:
    ...
    if dataset_name in ["fce", "wi.train", "wi.dev"]:  # json.
        return get_documents_from_json(document_file_paths, m2_file_paths, raw_ori_file_path, sp_ori_file_path)
    elif dataset_name in ["conll2013", "conll2014", "nucle"]:  # sgml.
        return get_documents_from_sgml(document_file_paths, m2_file_paths, raw_ori_file_path, sp_ori_file_path,
                                       dataset_name)
    else:  # lang8.
        return get_documents_from_lang8_entries_train(document_file_paths, raw_ori_file_path, sp_ori_file_path)
...
def make_context(raw_ori_file_path: str, sp_ori_file_path: str,
    ...
    previous_sp_ori_sentence = None
    previous_sp_ori_sentence_document_level_index = None
    with open(sp_ctx_file_path, "w") as sp_ctx_file:
        for sp_ori_sentence in sp_ori_sentences:
            ...
            previous_sp_ori_sentence = sp_ori_sentence
            previous_sp_ori_sentence_document_level_index = document_level_index
...
if __name__ == '__main__':
    ...
    wi_train_sp_ori_path = fp.WI_TRAIN_SP_ORI
    wi_train_doc_paths = [
    ...
    wi_dev_sp_ori_path = fp.WI_DEV_SP_ORI
    ...
    conll2013_sp_ori_path = fp.CONLL2013_SP_ORI
    ...
    conll2014_sp_ori_path = fp.CONLL2014_SP_ORI
    ...
    nucle_sp_ori_path = fp.NUCLE_SP_ORI
    ...
    lang8_sp_ori_path = fp.LANG8_SP_ORI
    ...
    # Single dataset.
    # raw_ori_path = lang8_raw_ori_path
    # sp_ori_path = lang8_sp_ori_path
    ...
    # make_context(raw_ori_path, sp_ori_path, doc_paths, m2_paths, n_prev, n_fol)
