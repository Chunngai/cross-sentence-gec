...
def main(args):
    ...
    # [CONTEXT]
    try:
        ctx_dict = getattr(task, 'context_dictionary', None)
    except NotImplementedError:
        ctx_dict = None
    ...
    with progress_bar.build_progress_bar(args, itr) as t:
        ...
        for sample in t:
            ...
            for i, sample_id in enumerate(sample['id'].tolist()):
                ...
                # Remove padding
                ctx_tokens = utils.strip_pad(sample['net_input']['ctx_tokens'][i, :], tgt_dict.pad())  # [CONTEXT]
                ...
                if align_dict is not None:
                    ctx_str = task.dataset(args.gen_subset).ctx.get_original_text(sample_id)  # [CONTEXT]
                ...
                if not args.quiet:
                    # [CONTEXT]
                    if ctx_dict is not None:
                        print('C-{}\t{}'.format(sample_id, ctx_str))
