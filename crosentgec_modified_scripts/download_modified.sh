...
models_url=http://sterling8.d2.comp.nus.edu.sg/~shamil/crosentgec/models/
...
models_url=http://sterling8.d2.comp.nus.edu.sg/downloads/GEC/mlconvgec2018/models/
...
#curl -L -o models/embed/model.vec $models_url/embeddings/wiki_model.vec
